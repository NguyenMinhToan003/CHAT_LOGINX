...
const RoomChat = () => {
  ...
  return (
    <div className='room-chat-container'>
      <Button onClick={()=>handleCancel()} sx={{backgroundColor: '#000000', color: '#ffffff', '&:hover': {backgroundColor: '#000000', color: '#ffffff'}}}>
        Quay Lại
      </Button>
      <div className='room-chat-fullscreen'>
          ...
          <div className='users-list'>
            {filteredUsers.length > 0 ? (
              filteredUsers.map((user) => (
                <div key={user._id} className='user-card' onClick={()=>navigate(`/chat-user/${user._id}`)}>
        ...
        {/* Right Side - Room List with Add Room Button */}
      ...
      {/* Create Room Popup - Member selection functionality here */}
      {showPopup && (
              ...
              <div className='form-group member-selection-section'>
                ...
                <div className='members-selection-list'>
                  {popupFilteredUsers.map((user) => (
                    <div 
                      key={user._id} 
                      className={`member-selection-item ${member.includes(user._id) ? 'selected' : ''}`}
